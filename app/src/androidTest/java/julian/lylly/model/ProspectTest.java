...
public class ProspectTest {
    ...
    public void testGetBudgets() {
        ...
        Prospect instance = new Prospect("test",new Tag("tag"),
                new LocalDate(2015,11,10), new LocalDate(2015,11,15),
                new Duration(1000*9), new Duration(1000*13),
                weights);
        List<Pair<Duration,Duration>> result = instance.getBudgets(new LocalDate(2015,11,11),
                                                                   new Duration(1000*1));
